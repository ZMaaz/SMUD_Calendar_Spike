...
def create_weeklyInterval(startDate, endDate):
...
for o1 in obj_9:
    ...
    for o2 in result:
        ...
        # print("Start 2 type: ", type(start2))
        # print(start2.year)
        # print(start2.month)
        # print(start2.day)
        ...
        startTime_1 = datetime.strptime(startTime, "%H:%M:%S").time()
        # print(type(startTime_1))
    
        date1 = datetime(start2.year, start2.month, start2.day, startTime_1.hour, startTime_1.minute, startTime_1.second)
        # print(date1)
        date2 = datetime.strftime(date1, "%Y-%m-%dT%H:%M:%S")
        print("Start date: ", date2)

      
        finish = o2["Finish"]
        finish2= datetime.strptime(finish, "%Y-%m-%d")
        finish3 = datetime.strftime(finish2, "%Y-%m-%dT%H:%M:%S")
        # print("Finish 3: ", finish3)

        
        # print(str(start2.year)+"-"+str(start2.month)+"-"+str(start2.day)+"T"+str(startTime_1.hour)+":"+str(startTime_1.minute)+":"+str(startTime_1.second))
        endTime = o2["End Time"]
        endTime1 = datetime.strptime(endTime,"%H:%M:%S").time() 
        date3 = datetime(start2.year, start2.month, start2.day, endTime1.hour, endTime1.minute, endTime1.second)
        # print(date3)
        date4 = datetime.strftime(date3, "%Y-%m-%dT%H:%M:%S")
        print("End Time: ", date4)
        yearlyLevelArray.append(create_weeklyInterval(date2, date4))
        ...
        calendarObj = {"CalendarKey": key, "Name": calendarName, "CalendarIntervals" : {"YearlyLevel": yearlyLevelArray,"YearlyShiftLevel": [], "WeeklyLevel": [], "WeeklyShiftLevel": [], "TimePhasedWeeklyLevel": [] }, "OverwriteExisting": True }
